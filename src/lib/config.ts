...
const envSchema = z.object({
  ...
  // Keep accepting APP_VERSION for backward compatibility, but release identity
  // is source-controlled from package.json and cannot be overridden at runtime.
  APP_VERSION: z.string().optional().transform(() => RELEASE_VERSION),
